...
-- For an already-live database, don't run this again — visit /api/setup
-- instead, which safely adds any missing columns without touching your data.
...
CREATE TABLE IF NOT EXISTS contacts (
  ...
  status TEXT DEFAULT 'lead', offering TEXT, hours TEXT, owner TEXT,
  called TEXT DEFAULT 'no', outcome TEXT DEFAULT '', source TEXT DEFAULT 'manual',
